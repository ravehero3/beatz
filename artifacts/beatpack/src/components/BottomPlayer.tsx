...
export default function BottomPlayer() {
  const { currentBeat, close } = useAudioStore();
  ...
  return (
    <>
      ...
      <div style={{
        ...
        alignItems: "center",
        gap: "12px",
        boxShadow: "0 8px 48px rgba(0,0,0,0.40), 0 2px 8px rgba(0,0,0,0.18), 0 0 0 1px rgba(0,0,0,0.08)",
