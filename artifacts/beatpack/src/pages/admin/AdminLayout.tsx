...
import { BarChart2, Users, UserCheck, Music, DollarSign, Flag, Settings, ArrowLeft, Store, Mail } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/emails", icon: <Mail size={16} />, label: "Email Previews" },
